 ...
 */
final class Tfplugin5Rpc implements TerraformProviderRpc {

    private final ProviderGrpc.ProviderBlockingStub stub;

    Tfplugin5Rpc(ProviderGrpc.ProviderBlockingStub stub) {
        this.stub = stub;
    }
    ...
    static TfSchema toTfSchema(Tfplugin5.Schema schema) {
        return new TfSchema(schema.getVersion(), toTfBlock(schema.getBlock()));
    }

    static TfBlock toTfBlock(Tfplugin5.Schema.Block block) {
        return new TfBlock(
