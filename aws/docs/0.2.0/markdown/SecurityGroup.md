...
| `ingress` | `any[]` | — | — | No | Inbound rules allowing traffic into resources |
| `egress` | `any[]` | — | — | No | Outbound rules allowing traffic from resources |
| `tags` | `object` | — | — | No | Tags to apply to the security group |
## Cloud Properties
