...
| `size` | `number` | — | — | No | The size of the volume in GiBs |
| `volumeType` | `string` | `gp3` | `gp2`, `gp3`, `io1`, `io2`, `st1`, `sc1`, `standard` | No | The volume type |
| `iops` | `number` | — | — | No | The number of I/O operations per second (IOPS) |
| `throughput` | `number` | — | — | No | The throughput in MiB/s. Only valid for gp3 volumes |
