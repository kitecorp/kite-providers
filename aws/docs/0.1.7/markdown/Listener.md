...
| `port` | `number` | — | — | No | The port on which the listener listens |
...
| `redirectConfig` | `any` | — | — | No | Redirect configuration when defaultActionType is 'redirect' |
| `fixedResponseConfig` | `any` | — | — | No | Fixed response configuration when defaultActionType is 'fixed-response' |
| `tags` | `object` | — | — | No | Tags to apply to the listener |
## Cloud Properties
