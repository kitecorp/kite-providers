...
| `managedPolicyArns` | `any[]` | — | — | No | ARNs of AWS managed policies to attach |
| `inlinePolicies` | `object` | — | — | No | Inline policies to embed in the role (name -> policy JSON) |
| `tags` | `object` | — | — | No | Tags to apply to the role |
## Cloud Properties
